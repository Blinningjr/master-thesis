...
This is one of the reason why \emph{GDB} is not a very good debugger for debugging optimized \emph{Rust} code. % TODO: Maby add a image of this, and link to the code.

Another problem with \meph{GDB} on optimized code is that if a variables value is only stored in a register then the time the value is know is very short because the register will be written over very soon after it is not needed.
