...
The \emph{VSCode} extension for the debugger \emph{Embedded Rust Debugger} is a very simple and bare bones implementation, the code for the extension is in the git repository \cite{erd-vscode}.
