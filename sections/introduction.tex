...
This makes creating tools that require debug information difficult and time-consuming to implemented, when it does not need to be.

\end{itemize}

The goals for this thesis is to create a new debugger and library that fix the problems mentioned above.
