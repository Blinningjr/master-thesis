...
Because most \emph{C} and \emph{C++} compilers does not have any limitations on how pointers can be used. 
...
Because those applications are often very important and need to work correctly, thus having a tool that can inspect the correctness is very important.
