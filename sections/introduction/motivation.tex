...
%The reason being that the number of paths in the code can be so extremely many that it is not feasible to make tests for all of them, instead it can be more feasible to check that the code works correctly.
