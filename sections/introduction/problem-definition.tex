...
The goal of solving this problem is to create a debugger that gives a better debugging experience for optimized \emph{Rust} code on embedded systems then some of the most commonly used debuggers, such as \emph{GDB} and \emph{LLDB}.
