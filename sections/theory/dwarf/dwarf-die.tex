...
The \glspl{die} are found in a tree structured referred to a as a \gls{die} tree.
Each \gls{die} tree will most often represents a whole compile unit or a type from the source code.
