...
One thing to note is that the prologue and epilogue code are not always two continues blocks of code that are in the beginning and end of a subroutine.
