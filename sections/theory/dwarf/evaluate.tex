...
Take note to the fact that the function \gls{die} called \emph{my\_function} has two attribute called \emph{DW\_AT\_low\_pc} and \emph{DW\_AT\_high\_pc}.
...
Now the first problem with parsing the value of the parameter \emph{val} into the correct type is knowing what type the parameter has, this is where the attribute \emph{DW\_AT\_type} comes in.
