...
And the other method called \emph{handle\_request} takes a \emph{DebugRequest} as a argument, and calls a function based on the argument.
...
These extension are very simple to create, because they only need to start the debugger and connect to it using the \emph{dap} protocol.
