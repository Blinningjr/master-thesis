...
One of these functionalities is the evaluation of current variable value.
Accessing the debug targets registers and memory is a different problem from reading and using the \gls{dwarf} format.
Thus, \emph{rust-debug} requires the user of the library to provide a solution for the problem.
