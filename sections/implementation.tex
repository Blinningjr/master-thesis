...
There are three different projects that make up the implementation, the first being a debug library called \emph{rust-debug}.
...
The debugger module mainly consists of one struct called \emph{DebugHandler}, its main job is to get the debug information from the \gls{DWARF} format.
...
The provided documentations also explains how to get started with creating an extension.
