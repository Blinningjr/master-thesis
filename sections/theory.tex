...
For example, if the source code has a function declared in another function then one of the children to the first functions \gls{die} will be the second functions \gls{die}.
...
There are several virtual unwinding rules, the ones for the registers are called register rules.
