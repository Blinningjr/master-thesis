...
Thus, a debugger enables a program to inspect every part of a program, this is especially true for modern debuggers, which have a lot more advanced features.
...
All the \gls{DWARF} sections are stored in an \gls{elf} file, which is a binary file format that is divided into different sections.
...
Thus, to simplify the explanation, an simple example will be used to explain the main part of evaluating a variable.
